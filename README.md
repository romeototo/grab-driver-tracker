...
- ประเภทรายการจะช่วยลงยอดรายจ่ายให้ตรงช่อง เช่น ค่าอาหาร ค่าซ่อมรถ หรือค่าโทร/เน็ต
- ตารางและ dashboard ในหน้าเว็บจะอัปเดตทันทีหลังบันทึกสำเร็จ

## เปิดใช้ PIN กันคนอื่นส่งข้อมูล

ค่าเริ่มต้นยังไม่บังคับ PIN เพื่อให้ทดสอบง่ายก่อน ถ้าต้องการล็อก endpoint:

1. ใน Apps Script ไปที่ Project Settings
2. เพิ่ม Script property ชื่อ `WEBHOOK_TOKEN`
3. ใส่ค่า PIN ที่ต้องการ เช่น `123456`
4. Deploy Apps Script เวอร์ชันใหม่
5. ใส่ PIN เดียวกันในช่อง `PIN ซิงก์` บนเว็บมือถือ
